...
def load_dataset_partial_ilids(csv_file, image_root, fail_on_missing=False):
    img_path = []
    # file_id = []
    person_id = []
    camera_id = []
    ...
    for file_name in file_list:
        ...
        person_id.append(file_name.split('.',1)[0])
        camera_id.append('0')
...
def main():
    ...
    _, data_fids = load_dataset_partial_ilids(args.dataset, args.image_root)
