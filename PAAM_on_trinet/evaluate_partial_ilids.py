...
parser.add_argument(
    '--batch_size', default=4, type=common.positive_int,
...
def main():
    ...
    query_pids, query_fids = embed_partial_ilids.load_dataset_partial_ilids(args.query_dataset, '/data1/chenyf/Partial_iLIDS/Probe')
    gallery_pids, gallery_fids = embed_partial_ilids.load_dataset_partial_ilids(args.gallery_dataset, '/data1/chenyf/Partial_iLIDS/Gallery')
    ...
    print('mAP: {:.2%} | top-1: {:.2%} top-2: {:.2%} | top-3: {:.2%} | top-10: {:.2%}'.format(
        mean_ap, cmc[0], cmc[1], cmc[2], cmc[9]))
